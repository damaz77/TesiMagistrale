...
\section{Portfolio selection as optimization problem}
...
\end{aligned}
\end{equation}
\footnotetext[1]{The condition $x \geq 0$ is often referred as \textit{long-only} investment strategy. In this paper we study exclusively long-only portfolios.}
